                  ...
                  mainPanel(navbarPage('Class Calculator', id = "inTabset", 
                                       ...
                                       tabPanel(title="Class Schemas", value = "panel1",
                                                ...
                                                tags$h3("What do each of these schemas mean?"),
                                                  ...
                                                  "The Great British Class Schema is in part a response to traiditional conceptualisations of social class that do not effectively capture the role of social and cultural processes in generating class divisions", tags$a(href= "https://doi.org/10.1177/0038038513481128", "(Savage et al 2013)"), "The GBCS derives seven classes that are indicative of combined social, cultural, and economic capital. The GBCS was originally dervied using Latent Class Analysis, the BBC version uses a simple derived logic tree found", tags$a(href= "https://www.ons.gov.uk/methodology/classificationsandstandards/otherclassifications/thenationalstatisticssocioeconomicclassificationnssecrebasedonsoc2010", "here."),
                                                
                                                  tags$h4("What is the Neo-Marxian Simplified Schema?"),
                                                  "Erik Olin Wright’s model of social stratification comes through an attempt to demonstrate social classes capacity to reveal the underlying dynamics of social processes of exploitation", tags$a(href= "https://www.sscc.wisc.edu/soc/faculty/pages/wright/Published%20writing/Class%20Strucutre%20and%20Income%20Determination-text.pdf", "(Wright 1979.)"), "Unlike Weberian concepts of class, Wright's schema goes beyond the conceptual argument. The Neo-Marxian class schema is derived from Wright's book 'Classes'", tags$a(href= "https://github.com/EOSSCC/Class-Calculator/blob/main/GBCS%20Logic%20Tree.docx", "see more here."),
                                                
                                                  tags$h4("What is the NS-SEC Schema?"),
                                                  "The National Statistics Socio-economic classification (NS-SEC) and seeks to measure the employment relations and conditions of occupations", tags$a(href= "https://doi.org/10.1177/0950017016653087", "(Williams 2017)."), "It is is the official socio-economic classification in the United Kingdom. The Coding structure behind NS-SEC was devised from", tags$a(href= "https://www.ons.gov.uk/methodology/classificationsandstandards/otherclassifications/thenationalstatisticssocioeconomicclassificationnssecrebasedonsoc2010", "the ONS website."),
                                       ...
                                       tabPanel(title="GBCS", value = "panel2",
                                                ...
                                                radioButtons("income", p("Total household income for you/spouse/significant other"),
                                       ...
                                       tabPanel(title= "Neo-Marxian Simplified", value= "panel3",
                                                conditionalPanel(
                                                  ...
                                                  conditionalPanel(
                                                    ...
                                                    radioButtons("WNoEs", p("About how many people are employed in this business on a permanent basis?"),
                                                                 choices= list("1"=1,"2-10"=2, "10+"=3, "Not Self-Employed N/A"=4), selected =4)),
                                                  conditionalPanel(
                                                    condition = "input.WNoEs == '1' || input.WNoEs == '2' || input.WNoEs == '3' || input.SelfEmployments == '1'",
                                                  ...
                                                  conditionalPanel(
                                                    ...
                                                    radioButtons("D2as", p("(1)Decisions to increase or decrease total number of people employed (2)Policy decisions to change products or services  (3)Change policy around pace of work  (4)Changing procedure (5)Decisions concerning budget (6)General policy decisions?"),
                                                                 choices= list("Yes"=1, "No"=2), selected =2),
                                                    conditionalPanel(
                                                  ...
                                                  conditionalPanel(
                                                    ...
                                                    radioButtons("C3as", p("(1)Deciding the specific tasks or work assignments performed by your subordinates (2)Deciding what procedures, tools, or materials your subordinates use in doing their work (3)Deciding how fast your subordinates work, how long they work, or how much work they have to get done"),
                                                                 choices= list("Yes"=1, "No"=2), selected =0),
                                                    tags$h3("Do you have any influence over the following possible sanctions that could be imposed upon subordinates?"),
                                                    radioButtons("C4as", p("(1)Granting a pay rise or promotion to a subordinate  (2)Preventing a subordinate from getting a pay rise or promotion because of poor work or misbehaviour (3)Firing or temporarily suspending a subordinate  (4)Issuing a formal warning to a subordinate"),
                                                                 choices= list("Yes"=1, "No"=2), selected =0)),
                                                  conditionalPanel(
                                       ...
                                       tabPanel(title= "NS-SEC", value= "panel4",
                                                ...
                                                conditionalPanel(
                                                  condition = "input.Employed == '1' || input.Employed == '2'",
                                                  tags$h3("Number of Employees"),
                                                  radioButtons("NoEmployees", p("About how many people are employed in this business on a permanent basis?"),
                                                               choices= list("1-24"=1, "25-499"=2, "500+"=3, "None"=4), selected = 4)),
                                       ...
                                       tabPanel(title= "Your Result", value= "panel6",
                                                conditionalPanel(
                                                  condition = "input.Classic == '1'",
                                                  tags$h3("Results"),
                                                ...
                                                conditionalPanel(
                                                  ...
                                                  verbatimTextOutput("camsisscore"),
                                                ),
                                                p("© T. V. Gunten and S.Oatley, University of Edinburgh, 2023, CC BY-SA."),
                                                ),
                                       tabPanel(title= "About", value= "panel7",
                                                tags$h3("About Page"),
...
server <- function(input, output, session) {
  ...
  output$WrightDefine<-renderText({
    if (capitals(input) ==1){
      ...
      result<-"Does not own sufficient capital, has low organisational assets and high skill/credential assets."
    }
    else if (capitals(input) ==4 & organisations(input) ==1 & skillss(input) ==2){
