...
authoritys<-function(input){
  ...
  else if (input$C1s ==1 & input$C2s ==2 & input$C3s ==2 & input$C3as ==1 & input$C4as ==1){
    return(4)
  }
  else if (input$C1s ==1 & input$C2s ==2 & input$C3s ==2 & input$C3as ==1 & input$C4as ==2){
    return(3)
  }
  else if (input$C1s ==1 & input$C2s ==2 & input$C3s ==2 & input$C3as ==2 & input$C4as ==2){
    return(2)
  }
  else if (input$C1s ==1 & input$C2s ==2 & input$C3s ==2 & input$C3as ==2 & input$C4as ==1){
    return(4)
  }
  else if (input$C1s ==1 & input$C2s ==2 & input$C3s ==1 & input$C3as ==1 & input$C4as ==1){
    return(4)
  }
  else if (input$C1s ==1 & input$C2s ==2 & input$C3s ==1 & input$C3as ==1 & input$C4as ==2){
    return(3)
  }
  else if (input$C1s ==1 & input$C2s ==2 & input$C3s ==1 & input$C3as ==2 & input$C4as ==2){
    return(2)
  }
  else if (input$C1s ==1 & input$C2s ==2 & input$C3s ==1 & input$C3as ==2 & input$C4as ==1){
    return(4)
  }
  else {
    return(1)
